...
class Window(QWidget):
    ...
    def _create_shedule_tab(self):
        ...
        self.shbox = QHBoxLayout()
        self.svboxa = QVBoxLayout()
        self.svboxb = QVBoxLayout()
        self.svboxc = QVBoxLayout()
        self.svbox2 = QVBoxLayout()
        self.shbox2 = QHBoxLayout()
        self.svbox3 = QVBoxLayout()
        self.shbox3 = QHBoxLayout()

        self.svbox.addLayout(self.shbox)
        self.shbox.addLayout(self.svboxa)
        self.shbox.addLayout(self.svboxb)
        self.shbox.addLayout(self.svboxc)
        self.svbox2.addLayout(self.shbox2)
        self.svbox3.addLayout(self.shbox3)

        self.svboxa.addWidget(self.monday_gbox)
        self.svboxb.addWidget(self.tuesday_gbox)
        self.svboxc.addWidget(self.wednesday_gbox)
        self.svboxa.addWidget(self.thursday_gbox)
        self.svboxb.addWidget(self.friday_gbox)
        self.svboxc.addWidget(self.saturday_gbox)
        self.shbox2.addWidget(self.teacher_gbox)
        self.shbox3.addWidget(self.subject_gbox)
        ...
        self.svbox.addWidget(self.update_shedule_btn)
        self.svbox2.addWidget(self.update_teacher_btn)
        self.svbox3.addWidget(self.update_subject_btn)
    ...
    def _create_saturday_table(self):
        ...
        self._create_day_table(self.saturday_table, self.saturday_gbox, 'Сб')
