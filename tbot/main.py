...
conn = psycopg2.connect(database="t_t", user="postgres", password="ag1212200223", host="localhost", port="5432")
cursor = conn.cursor()

day = ['Пн', 'Вт', 'Ср', 'Чт', 'Пт', 'Сб', 'Воскресенье']
...
if datetime.datetime.isoweekday(d1) < 6:
